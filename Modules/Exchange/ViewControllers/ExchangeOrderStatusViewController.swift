//
//  ExchangeOrderStatusViewController.swift
//  MyMonero
//
...
import UIKit
//
class ExchangeOrderStatusViewController: UIView
{
...
//	var deleteButton: UICommonComponents.LinkButtonView?
	...
	// These get set when invoking this modal from ExchangeSendFundsViewController
//	var wallet: Wallet?
//	var orderDetails: OrderDetails?
//
//	// Lifecycle - Init
//
//	override init(selectedWallet: Wallet?, orderDetails: OrderDetails?)
//	{
//		super.init()
//		let self.wallet = selectedWallet
//		let self.orderDetails = orderDetails
//	}
//	required init?(coder aDecoder: NSCoder) {
//		fatalError("init(coder:) has not been implemented")
//	}
