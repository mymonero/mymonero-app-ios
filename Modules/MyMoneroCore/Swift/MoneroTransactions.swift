...
func Monero_isTransactionConfirmed(_ tx_height: Int, _ blockchain_height: Int) -> Bool
{
	return (blockchain_height - tx_height) > MoneroConstants.txMinConfirms
}
func Monero_isTxUnlocked(_ tx_unlockTime: Double, _ blockchain_height: Int) -> Bool
{
...
func Monero_txLockedReason(_ tx_unlockTime: Double, _ blockchain_height: Int) -> String
{
